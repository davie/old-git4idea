...
public abstract class BasicAction extends AnAction
{
	...
	public void actionPerformed( @NotNull AnActionEvent event )
	{
		...
		final com.assembla.git.GitVcs mksvcs = com.assembla.git.GitVcs.getInstance( project );
	...
	protected abstract void perform( @NotNull Project project, com.assembla.git.GitVcs mksVcs, @NotNull List<VcsException> exceptions,
	...
	protected VirtualFile[] collectAffectedFiles( @NotNull Project project, @NotNull VirtualFile[] files )
	{
		...
		{
			if( !file.isDirectory() && projectLevelVcsManager.getVcsFor( file ) instanceof com.assembla.git.GitVcs)
			{
	...
	public void update( @NotNull AnActionEvent e )
	{
		...
		com.assembla.git.GitVcs mksvcs = com.assembla.git.GitVcs.getInstance( project );
	...
	protected abstract boolean isEnabled( @NotNull Project project, @NotNull com.assembla.git.GitVcs mksvcs, @NotNull VirtualFile... vFiles );
